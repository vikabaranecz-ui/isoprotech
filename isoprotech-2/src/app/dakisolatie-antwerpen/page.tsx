...
export const metadata: Metadata = {
  ...
  description: "Dakisolatie en dakrenovatie in Antwerpen. Plat en hellend dak. Tot €5.200 premies. Gratis inspectie, vaste prijs, 10 jaar garantie. Bel +32 465 88 27 01.",
  ...
  return (
    <>
        ...
        <div className="relative container-wide py-28">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col gap-2 mb-8">
              {["Gratis inspectie ter plaatse", "Tot €5.200 aan premies", "Vaste prijs zonder verrassingen", "10 jaar garantie op de werken"].map((t) => (
      ...
      <section className="section-padding bg-green-50">
        <div className="container-wide max-w-3xl mx-auto">
          <h2 className="text-3xl font-extrabold text-teal-800 text-center mb-4">Premies voor dakisolatie</h2>
          <p className="text-center text-gray-600 mb-8 max-w-xl mx-auto">Combineer premies voor maximaal voordeel. Wij helpen u bij de aanvraag.</p>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { name: "Fluvius", amount: "tot €3.500", desc: "€7/m², max €3.500 bij R ≥ 4.5" },
              { name: "Mijn VerbouwPremie", amount: "tot €1.200", desc: "Woningen gebouwd vóór 2006" },
              { name: "Gemeente Antwerpen", amount: "tot €500", desc: "Dakoppervlakte vanaf 40 m²" },
            ].map((p) => (
