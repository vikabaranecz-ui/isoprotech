...
import { BRAND, PHOTOS, VIDEOS, INSTAGRAM, SOCIAL } from "@/lib/constants";
  ...
  return (
    <>
      ...
      <section className="relative min-h-[540px] flex items-center overflow-hidden">
        ...
        <div className="relative container-wide py-32 max-w-4xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold text-white md:text-5xl lg:text-[3.5rem] leading-[1.1] mb-5">
              Uw dak of gevel isoleren?
              <span className="block text-orange-400">Wij regelen het. Compleet.</span>
            </h1>
            <p className="text-lg md:text-xl text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <Link href="/calculator" className="btn-outline-light text-base px-8 py-4">
              Bereken uw prijs
            </Link>
          </div>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm text-white/60 font-medium">
            <span>Google 5/5</span>
            <span>10 jaar garantie</span>
            <span>Gratis inspectie</span>
            <span>Antwerpen en omgeving</span>
          </div>
        </div>
      </section>
        ...
        <div className="container-wide">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">
              Bekijk onze nieuwste projecten, tips en voor-en-na transformaties.
            </p>
          </div>
          <div className="grid gap-5 sm:grid-cols-3 max-w-5xl mx-auto">
            {INSTAGRAM.reels.map((reel) => (
