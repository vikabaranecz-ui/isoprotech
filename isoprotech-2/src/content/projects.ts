...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Binnentuin crepi Berchem — technische hoekafwerking",
  ...
  {
    id: "crepi-hoboken-1",
    slug: "crepi-gevelrenovatie-hoboken",
    title: "Crepi gevelrenovatie Hoboken — van verweerd naar smetteloos wit",
    ...
    workType: ["Gevelisolatie", "Crepi"],
    serviceSlug: "crepi",
    summary: "Verweerde gevel in Hoboken volledig vernieuwd met isolatie en strakke witte minerale crepi. Voor- en nafoto tonen de indrukwekkende transformatie.",
    problem: "Een rijwoning in Hoboken had een verouderde bepleistering die op meerdere plaatsen losging, barsten vertoonde en vochtplekken had. De eigenaar wou een duurzame oplossing die tegelijk de gevel laat ademhalen en isoleert.",
    solution: "ISOPROTECH verwijderde de loskomende lagen, behandelde de ondergrond met hechtingprimer en bracht EPS-isolatieplaten aan. Als afwerking werd een fijnkorrelige witte minerale crepi aangebracht — dampopen, vorstbestendig en UV-stabiel. Alle raamaansluitingen werden waterdicht afgedicht met PVC-profielen.",
    result: "Een strakke, witte gevel in Hoboken die de woning als nieuwbouw doet ogen. Geen barsten, geen vochtproblemen. De eigenaar merkt dat de woning in de winter merkbaar minder snel afkoelt.",
    seo: {
      title: "Crepi Gevelrenovatie Hoboken — Voor & Na | ISOPROTECH",
      description: "Verweerde gevel in Hoboken volledig vernieuwd met isolatie en witte minerale crepi. Bekijk de voor- en nafoto's van dit gevelrenovatieproject.",
      keywords: ["crepi hoboken", "gevelrenovatie hoboken", "gevelisolatie hoboken", "crepi antwerpen hoboken"],
    },
  },
  {
    id: "crepi-hoboken-2",
    slug: "crepi-hoboken-achterzijde",
    title: "Crepi Hoboken — achterzijde en hoekafwerking vakkundig afgewerkt",
    photo: PHOTOS.crepiHoboken2After,
    beforePhoto: PHOTOS.crepiHoboken1Before,
    location: "Hoboken",
    citySlug: "antwerpen",
    workType: ["Gevelisolatie", "Crepi"],
    serviceSlug: "crepi",
    summary: "Tweede gevelzijde van dezelfde woning in Hoboken — technische hoekafwerking en naadloze aansluiting op de voorgevel.",
    problem: "Na de renovatie van de voorgevel bleek ook de achterzijde van de woning in Hoboken aan vernieuwing toe. De overgang van voor- naar achterkant — inclusief de buitenhoek — moest naadloos en professioneel worden aangesloten.",
    solution: "ISOPROTECH werkte de achterzijde af met dezelfde isolatieopbouw en crepi-afwerking als de voorgevel. De buitenhoeken werden strak getroffeerd met aluminium hoekprofielen. De aansluiting op de dakgoot en de tegelband bij de sokkel werden waterdicht afgewerkt.",
    result: "Een woning in Hoboken die aan alle kanten uniform en verzorgd oogt. De rondomaanpak zorgt voor maximale isolatieprestaties — geen koudebruggen meer aan de hoeken.",
    seo: {
      title: "Crepi Hoboken Achterzijde — Hoekafwerking | ISOPROTECH",
      description: "Achterzijde en hoekafwerking met crepi op woning in Hoboken. Naadloze aansluiting op voorgevel. Bekijk het eindresultaat van ISOPROTECH.",
      keywords: ["crepi achtergevel hoboken", "hoekafwerking crepi hoboken", "gevelisolatie hoboken", "crepi rondom hoboken"],
    },
  },
  {
    id: "crepi-mechelen",
