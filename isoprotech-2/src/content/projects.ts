...
export const projects: Project[] = [
  {
    ...
    seo: {
      title: "Plat Dak Renovatie Antwerpen — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Plat Dak Vernieuwing Antwerpen — Voor & Na",
  ...
  },
  {
    ...
    seo: {
      title: "Binnentuin Renovatie met Crepi Berchem Antwerpen",
  ...
  },
  {
    ...
    extraBeforeAfterPairs: [
      { before: PHOTOS.hellendDakEdegemBefore2, after: PHOTOS.hellendDakEdegemAfter1 },
    ],
    location: "Edegem",
    citySlug: "edegem",
    workType: ["Dakrenovatie", "Dakisolatie"],
    ...
    seo: {
      title: "Hellend Dak Renovatie Edegem — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Spuitkurk Gevelafwerking Antwerpen — Voor & Na",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Achtergevel Antwerpen — Voor & Na",
  ...
  },
  {
    ...
    seo: {
      title: "Gevelisolatie Appartement Antwerpen — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Voorgevel Renovatie Antwerpen — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Buitengevelisolatie met Crepi Meise",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Afwerking Rondom Meise — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Gevelafwerking Schilde — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Groot Plat Dak Renovatie Antwerpen — Dronefilm",
  ...
  },
  {
    ...
    seo: {
      title: "Oranje Crepi Gevelafwerking Antwerpen — Case Study",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Gevelisolatie Hoboken — Voor & Na",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi Gevelafwerking Mechelen — Voor & Na",
  ...
  },
  {
    ...
    problem: "De eigenaar van deze woning in Meise had eerder twee aannemers ingehuurd die het werk niet afmaakten. De eerste begon met isolatieplaten op een deel van de gevel en verdween vervolgens zonder bericht. De tweede deed hetzelfde: EPS-platen werden onregelmatig en zonder correcte hechtmortel aangebracht, sommige geveldelen werden zelfs nooit aangeraakt. Jarenlang stond de woning half ingepakt in losse isolatieplaten — een situatie die niet alleen esthetisch onhoudbaar was, maar ook structurele vochtproblemen veroorzaakte doordat de platen water vasthielden zonder afwerking.",
    solution: "ISOPROTECH begon met een grondige inspectie van wat de vorige aannemers hadden achtergelaten. Losse en verkeerd geplaatste isolatieplaten werden verwijderd of herbevestigd. Geveldelen die nooit waren aangeraakt werden alsnog volledig voorbereid. Vervolgens werd de volledige gevel opnieuw opgebouwd met correct verlijmde en mechanisch bevestigde EPS-isolatieplaten van 100 mm, gevolgd door glasvezelarmering en witte minerale crepi. Alle aansluitingen, hoeken en geveldoorbrekingen werden vakkundig afgewerkt.",
    result: "Een woning in Meise die eindelijk de afwerking kreeg die ze al jaren verdiende. De voor- en nafoto's spreken voor zich: van losse isolatieplaten en onafgewerkte muren naar een strakke, uniforme crepi-gevel. De eigenaar hoeft voortaan geen tweede mening meer te vragen — het werk is gedaan, en het is gedaan zoals het hoort.",
    seo: {
      title: "Gevelisolatie + Crepi Meise — Voor & Na Foto's",
  ...
  },
  {
    ...
    seo: {
      title: "Totaalrenovatie Berchem — Gevel, Platdak & Ramen",
  ...
  },
  {
    ...
    seo: {
      title: "Gevelisolatie + Crepi Wijnegem — Voor & Na",
  ...
  },
  {
    ...
    slug: "plat-dak-renovatie-lozanastraat-antwerpen",
    title: "Plat dak renovatie Lozanastraat Antwerpen — volledig vernieuwd",
    ...
    workType: ["Dakrenovatie", "Dakisolatie"],
    serviceSlug: "dakrenovatie",
    summary: "Volledig vernieuwd plat dak op een woning aan de Lozanastraat in Antwerpen. Van verouderde, lekkende dakbedekking naar een waterdicht en goed geïsoleerd dak.",
    problem: "De eigenaar aan de Lozanastraat in Antwerpen kampte al jaren met waterinfiltratie via het plat dak. De bestaande dakbedekking was sterk verouderd, vertoonde scheuren en blaasvorming en kon het regenwater niet meer correct afvoeren. Tijdelijke herstellingen hadden het probleem telkens slechts enkele maanden uitgesteld.",
    solution: "ISOPROTECH verwijderde de volledige bestaande dakopbouw tot op de draagvloer. Een nieuw dampscherm werd aangebracht, gevolgd door PIR-isolatieplaten voor een hoge isolatiewaarde. Als afdekking werd een tweelaags bitumen dakbedekking met elastomeer aangebracht en gefakkeld. Alle dakrandafsluitingen, afvoerputjes en loodaansluitingen werden meegenomen en correct afgewerkt.",
    result: "Een volledig waterdicht, goed geïsoleerd plat dak aan de Lozanastraat in Antwerpen. De eigenaar is verlost van vochtproblemen en lekkages. Het dak heeft een garantie van 10 jaar op materialen en uitvoering.",
    seo: {
      title: "Plat Dak Renovatie Lozanastraat Antwerpen",
