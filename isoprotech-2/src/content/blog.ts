...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: "spouwmuurisolatie-of-buitengevelisolatie",
    slug: "spouwmuurisolatie-of-buitengevelisolatie",
    title: "Spouwmuurisolatie of buitengevelisolatie — wat past bij uw woning?",
    date: "2026-05-15",
    dateDisplay: "15 mei 2026",
    category: "Gevelisolatie",
    readTime: "7 min",
    excerpt: "Heeft u een spouwmuur of een volle muur? De keuze bepaalt welke isolatietechniek het beste werkt. Ontdek de voor- en nadelen van beide oplossingen.",
    photo: PHOTOS.gevelCrepiMeise,
    body: [
      { type: "text", content: "Wie zijn woning wil isoleren, stuit vaak op dezelfde vraag: 'Is spouwmuurisolatie niet goedkoper?' Het antwoord is genuanceerd. De beste keuze hangt af van uw muurtype, de staat van uw gevel en uw doelstellingen op het vlak van energieprestatie en uitstraling. In dit artikel leggen we het verschil uit zodat u een weloverwogen beslissing kunt nemen." },
      { type: "heading", content: "Wat is het verschil?" },
      { type: "text", content: "Bij spouwmuurisolatie wordt isolatiemateriaal (doorgaans EPS-parels of minerale wol) ingeblazen via kleine boorgaten in de bestaande buitengevel. De muur blijft uiterlijk ongewijzigd. Bij buitengevelisolatie (ook wel ETICS of naïsolatie via de buitenzijde) wordt een nieuw isolatiesysteem op de bestaande buitenmuur gekleefd en gedibeld, afgewerkt met crepi, spuitkurk of steenstrips. U krijgt een volledig nieuwe gevel." },
      { type: "heading", content: "Wanneer is spouwmuurisolatie geschikt?" },
      { type: "text", content: "Spouwmuurisolatie werkt uitsluitend als uw woning een lege of onvoldoende gevulde spouw heeft — een luchtlaag tussen de binnen- en buitenspouwblad. Dit is typisch het geval bij woningen gebouwd tussen 1945 en 1980. Voorwaarden: de spouw moet minstens 5 cm breed zijn, droog, en vrij van bruggen of beschadigingen. Is aan die voorwaarden voldaan, dan is spouwvulling inderdaad de snelste en goedkoopste optie: er zijn geen stellingen nodig en de werken zijn in één dag klaar." },
      { type: "heading", content: "De beperkingen van spouwmuurisolatie" },
      { type: "text", content: "Spouwvulling lost echter een beperkt probleem op. Ten eerste bereikt u een lagere U-waarde dan bij buitengevelisolatie — de maximale isolatielaag is immers beperkt tot de breedte van de spouw. Ten tweede pakt het de koudebruggen ter hoogte van de vloerplaten en lateien niet aan. Ten derde verandert er niets aan de uitstraling van uw gevel. Heeft u een verweerde, scheurgevoelige of verouderde gevel? Dan lost spouwvulling dat probleem niet op." },
      { type: "heading", content: "Wanneer is buitengevelisolatie de betere keuze?" },
      { type: "text", content: "Buitengevelisolatie is de juiste keuze als: (1) uw woning geen spouw heeft — dit is vrijwel altijd het geval bij woningen gebouwd vóór 1945; (2) uw spouw te smal, beschadigd of al gevuld is; (3) u een hogere isolatiewaarde wil bereiken dan spouwvulling toelaat; (4) uw gevel aan vernieuwing toe is — scheuren, afbladdering, waterinfiltratie; (5) u wil voldoen aan de strengste EPC-normen voor verkoop of verhuur." },
      { type: "heading", content: "De combinatie: het beste van twee werelden?" },
      { type: "text", content: "In sommige gevallen wordt een combinatie toegepast: eerst de spouw vullen, dan buitengevelisolatie plaatsen. Dit geeft de allerbeste isolatiewaarden, maar is ook de duurste optie. Voor de meeste woningen in de Antwerpse regio is buitengevelisolatie op een volle muur de aangewezen oplossing, eventueel na een grondige inspectie van de spouwsituatie." },
      { type: "heading", content: "Prijs: wat kost elk systeem?" },
      { type: "text", content: "Spouwmuurisolatie kost doorgaans €15 tot €30 per m² gevel, afhankelijk van het gebruikte materiaal en de breedte van de spouw. Buitengevelisolatie met crepi of spuitkurk kost €140 tot €230 per m² inclusief afwerking — maar u krijgt ook een volledig nieuwe gevel en een hogere isolatiewaarde. Via Mijn Verbouwpremie kunt u voor beide technieken premies aanvragen in Vlaanderen." },
      { type: "heading", content: "Hoe weet u welk muurtype u heeft?" },
      { type: "text", content: "De snelste manier: meet de dikte van uw buitenmuur via een vensteropening. Een volle muur is doorgaans 20 tot 30 cm dik. Een spouwmuur is 27 tot 40 cm dik (twee bladen + spouw). Als u het niet zeker weet, laat een vakman een boorgaatje plaatsen in de muur om te controleren of er een luchtlaag is. ISOPROTECH voert dit standaard uit tijdens de gratis inspectie." },
      { type: "heading", content: "Conclusie" },
      { type: "text", content: "Spouwmuurisolatie is een uitstekende, betaalbare oplossing — maar alleen als uw woning er geschikt voor is en u geen hogere ambities heeft. Wilt u maximale isolatiewaarden, een nieuwe gevel en toekomstbestendigheid? Dan is buitengevelisolatie de betere investering. Twijfelt u? Plan een gratis inspectie en onze vakman adviseert u op basis van uw specifieke situatie." },
    ],
  ...
  {
    id: "dakisolatie-prijs-m2-2026",
    slug: "dakisolatie-prijs-m2-2026",
    title: "Dakisolatie prijs per m² in 2026 — eerlijke richtprijzen voor Antwerpen",
    date: "2026-05-20",
    dateDisplay: "20 mei 2026",
    category: "Dakisolatie",
    readTime: "6 min",
    excerpt: "Wat kost dakisolatie echt in 2026? Eerlijke richtprijzen per daktype, materiaal en afwerking — inclusief premies en terugverdientijd.",
    photo: PHOTOS.dakisolatieTeam,
    body: [
      { type: "text", content: "Wat kost dakisolatie per m² in 2026? Het is de vraag die elke woningeigenaar stelt voordat hij een vakman belt. Het eerlijke antwoord: dat hangt af van uw daktype, het isolatiemateriaal en de dikte. Maar met onderstaande richtprijzen weet u waar u staat — en hoe snel u de investering terugverdient." },
      { type: "heading", content: "Richtprijs dakisolatie plat dak" },
      { type: "text", content: "Bij een plat dak wordt de isolatie bovenop de draagstructuur geplaatst, gecombineerd met een nieuwe waterdichte dakbedekking. De totaalprijs omvat isolatieplaten (PIR of EPS), onderdak, afwerklaag (EPDM of bitumen) en arbeid. Richtprijs in 2026: €80 tot €130 per m² voor een volledig plat dakpakket inclusief dakbedekking. Enkel isolatie bijplaatsen op een nog goede bedekking: €40 tot €70 per m²." },
      { type: "heading", content: "Richtprijs dakisolatie hellend dak" },
      { type: "text", content: "Bij een hellend dak wordt isolatie doorgaans aan de binnenzijde aangebracht, tussen of onder de dakspanten. Materialen: minerale wol, glaswol of PIR-platen. Richtprijs 2026: €35 tot €65 per m² voor inblaasisolatie of het plaatsen van isolatiemat tussen de spanten, inclusief dampscherm en dampopen folie. Exclusief de afwerking van de zoldervloer of plafond." },
      { type: "heading", content: "Wat bepaalt de uiteindelijke prijs?" },
      { type: "text", content: "Vijf factoren bepalen de eindprijs van dakisolatie: (1) Dakoppervlakte — grotere daken zijn efficiënter in uitvoering per m². (2) Isolatiedikte — een dikkere laag geeft een betere U-waarde maar kost meer. (3) Staat van het bestaande dak — bij een verouderde dakbedekking moet die eerst vernieuwd worden. (4) Toegankelijkheid — moeilijk bereikbare daken vergen meer arbeid. (5) Materiaaltype — PIR is duurder dan EPS of glaswol, maar biedt hogere isolatiewaarde per cm." },
      { type: "heading", content: "Premies dakisolatie in 2026" },
      { type: "text", content: "Via Mijn Verbouwpremie kunt u in Vlaanderen een premie aanvragen voor dakisolatie. De premie bedraagt €8 tot €18 per m² isolatie, afhankelijk van uw inkomenssituatie en de behaalde isolatiewaarde (R ≥ 4,5 m²K/W). Heeft u asbestdakleien? Dan geldt extra de asbestbonus van €8/m² bovenop de standaardpremie. Voor een gemiddeld plat dak van 60 m² kan de totale premie oplopen tot €1.500 of meer." },
      { type: "heading", content: "Terugverdientijd: wanneer is het rendabel?" },
      { type: "text", content: "Een ongeïsoleerd dak is verantwoordelijk voor 25 tot 30% van het totale warmteverlies van een woning. Bij een gemiddeld gezin met een energiefactuur van €2.500/jaar bespaart dakisolatie jaarlijks €500 tot €700. Bij een investeringskost van €4.000 (na premies) is de terugverdientijd dus 6 tot 8 jaar. Daarna profiteert u elke jaar opnieuw van de besparing." },
      { type: "heading", content: "Hellend of plat dak: wat is duurder?" },
      { type: "text", content: "Per m² is dakisolatie van een hellend dak goedkoper dan een volledig plat dakpakket — maar bij een hellend dak moet u ook rekening houden met de grotere oppervlakte (door de helling) en eventuele afwerkingskosten binnenin. In de praktijk zijn de totaalkosten vergelijkbaar voor een gemiddelde woning van 8 bij 9 meter." },
      { type: "heading", content: "Gratis inspectie: uw exacte prijs" },
      { type: "text", content: "Richtprijzen zijn een goede leidraad, maar uw exacte prijs hangt af van uw specifieke situatie. ISOPROTECH voert een gratis dakisolatie-inspectie uit in de regio Antwerpen. Onze vakman bekijkt uw dak, meet op, controleert de huidige staat en geeft u een concrete offerte zonder verplichtingen. Zo weet u exact waar u aan toe bent, vóór u beslist." },
    ],
  ...
  {
    id: "epc-labelpremie-deadline-30-juni-2026",
    slug: "epc-labelpremie-deadline-30-juni-2026",
    title: "EPC-labelpremie: vraag vóór 30 juni aan of je verliest duizenden euro's",
    date: "2026-05-30",
    dateDisplay: "30 mei 2026",
    category: "Premies & subsidies",
    readTime: "5 min",
    excerpt: "De EPC-labelpremie verdwijnt op 30 juni 2026. Wie isolatiewerken uitvoerde maar nog niet aanvroeg, moet nú handelen. Wacht niet — de deadline is hard.",
    photo: PHOTOS.gevelAfter1,
    body: [
      { type: "text", content: "De EPC-labelpremie van het Vlaams Energie- en Klimaatagentschap (VEKA) sluit definitief op 30 juni 2026. Woningeigenaren die dakisolatie, gevelisolatie of spouwmuurisolatie lieten uitvoeren en nog geen aanvraag indienden, riskeren duizenden euro's premie mis te lopen. De aanvraag verloopt via het digitale loket van Mijn VerbouwPremie — en de procedure vraagt meer tijd dan de meeste eigenaars beseffen." },
      { type: "heading", content: "Hoeveel bedraagt de EPC-labelpremie in 2026?" },
      { type: "text", content: "De premie varieert naargelang uw inkomenscategorie en het bereikte EPC-label na renovatie. Voor de laagste inkomensgroep (categorie 1) bedraagt de premie tot €10.000 bij een sprong naar EPC-label A. Voor middeninkomens (categorie 2) loopt dat op tot €5.000. Eigenaar-bewoners met een hoger inkomen (categorie 3) kunnen tot €2.500 ontvangen. Naast de labelpremie blijven de afzonderlijke renovatiepremies voor dakisolatie en gevelisolatie beschikbaar via Mijn VerbouwPremie." },
      { type: "heading", content: "Welke werken tellen mee voor de EPC-labelpremie?" },
      { type: "text", content: "Alle erkende energiebesparende werken die leiden tot een aantoonbare verbetering van het EPC-label komen in aanmerking: dakisolatie, vloerisolatie, spouwmuurisolatie, buitengevelisolatie, hoogrendementsbeglazing en de installatie van een warmtepomp of zonneboiler. De werken moeten uitgevoerd zijn door een erkend aannemer — zoals Isoprotech — en u hebt een EPC opgemaakt vóór en na de werken nodig als bewijs van de labelsprong." },
      { type: "heading", content: "Hoe de premie aanvragen vóór de deadline?" },
      { type: "text", content: "De aanvraag verloopt digitaal via het loket van Mijn VerbouwPremie op verbouwpremie.be. U hebt nodig: uw identiteitskaart, het voor- en na-EPC-attest, de facturen van de erkende aannemer en uw aanslagbiljet voor de inkomenscategorie. Dien uw aanvraag in zodra alle documenten beschikbaar zijn — een aanvraag op 29 juni is geldig, maar het systeem kan overbelast raken naarmate de deadline nadert. Wacht dus niet tot de laatste dag." },
      { type: "heading", content: "Isolatie laten uitvoeren vóór 30 juni: is dat nog haalbaar?" },
      { type: "text", content: "Voor wie nog geen isolatiewerken heeft laten uitvoeren: het is krap, maar niet onmogelijk. Dakisolatie van een gemiddelde rijwoning duurt 2 tot 4 werkdagen. Buitengevelisolatie met crepi neemt 1 tot 2 weken in beslag. Isoprotech werkt in de regio Antwerpen — Wilrijk, Mortsel, Deurne, Berchem en omgeving. Neem zo snel mogelijk contact op voor een spoedafspraak en bespreek of uitvoering voor de deadline haalbaar is. Gratis inspectie ter plaatse, binnen 48 uur contact." },
      { type: "heading", content: "Wat verandert na 1 juli 2026?" },
      { type: "text", content: "Na 30 juni 2026 vervalt de EPC-labelpremie. De afzonderlijke renovatiepremies voor dakisolatie en gevelisolatie via Mijn VerbouwPremie blijven wél bestaan — maar de extra bonus op een labelsprong verdwijnt. Bovendien geldt voor wie een woning kocht met EPC-label E of F de renovatieplicht: het label moet binnen 5 jaar na aankoop naar minimum D worden gebracht. Die verplichting staat los van de deadline op 30 juni." },
    ],
    relatedSlugs: ["epc-label-e-f-renovatieplicht-antwerpen-2026", "gevelisolatie-voordelen-2026", "dakisolatie-prijs-m2-2026"],
    relatedServiceSlugs: ["dakisolatie", "gevelisolatie", "spouwmuurisolatie"],
    seo: {
      title: "EPC-labelpremie deadline 30 juni 2026 — Vraag nu aan",
      description: "De EPC-labelpremie verdwijnt op 30 juni 2026. Tot €10.000 premie voor een labelsprong. Hoe aanvragen? Welke werken tellen? ISOPROTECH Antwerpen.",
    },
  },
  {
    id: "gasfactuur-stijgt-dakisolatie-besparing-antwerpen-2026",
    slug: "gasfactuur-stijgt-dakisolatie-besparing-antwerpen-2026",
    title: "Uw gasfactuur stijgt opnieuw: wat doet dakisolatie voor uw rekening in Antwerpen?",
    date: "2026-05-28",
    dateDisplay: "28 mei 2026",
    category: "Dakisolatie",
    readTime: "6 min",
    excerpt: "Energieprijzen blijven stijgen. Dakisolatie is de meest effectieve ingreep om uw verwarmingsrekening structureel te verlagen — met bewezen besparingen van 20 tot 30%.",
    photo: PHOTOS.platDak,
    body: [
      { type: "text", content: "Dakisolatie bespaart u gemiddeld 20 tot 30% op uw jaarlijkse verwarmingsfactuur. Bij een gemiddelde Antwerpse rijwoning met een gasrekening van €1.800 per jaar betekent dat een structurele besparing van €360 tot €540 — elk jaar opnieuw. Met de energieprijzen die opnieuw stijgen in 2026, wordt de terugverdientijd van dakisolatie korter dan ooit." },
      { type: "heading", content: "Hoeveel stijgen de energieprijzen in 2026?" },
      { type: "text", content: "De CREG (Commissie voor de Regulering van de Elektriciteit en het Gas) registreert voor 2026 een gemiddelde gasprijsstijging van 8 tot 12% ten opzichte van 2025. Een gezin dat vorig jaar €1.700 betaalde voor verwarming, betaalt dit jaar gemakkelijk €100 tot €200 meer — zonder extra verbruik. Structurele isolatie is de enige maatregel die uw verbruik zelf verlaagt, ongeacht de marktprijs." },
      { type: "heading", content: "Hoe bespaart dakisolatie op uw energierekening?" },
      { type: "text", content: "Via een niet-geïsoleerd dak ontsnapt tot 30% van de warmte die u betaalt. Een goed geïsoleerde zolder of plat dak houdt die warmte binnen. In de winter verhoogt dit de comfort-temperatuur bij gelijke verwarming. In de zomer houdt het de woning koeler. Het Vlaams Energie- en Klimaatagentschap (VEKA) bevestigt een gemiddelde verbetering van het EPC-label met 1 tot 2 stappen bij een volledige dakisolatie — wat ook premies en woningwaarde beïnvloedt." },
      { type: "heading", content: "Wat kost dakisolatie in Antwerpen in 2026?" },
      { type: "text", content: "De richtprijs voor dakisolatie in Antwerpen ligt in 2026 op €25 tot €50 per m² voor een hellend dak (langs de binnenzijde, inclusief dampscherm en afwerking) en €80 tot €130 per m² voor een plat dak inclusief nieuwe dakbedekking. Voor een rijwoning van 50 m² dakoppervlak betekent dit een investering van €1.250 tot €2.500 voor een hellend dak. Na aftrek van de Mijn VerbouwPremie en het verlaagde btw-tarief van 6% kan dit significanter lager uitvallen." },
      { type: "heading", content: "Terugverdientijd dakisolatie: wanneer verdient u terug?" },
      { type: "text", content: "Bij een investering van €2.000 en een jaarlijkse besparing van €450 is de terugverdientijd minder dan 5 jaar — vóór premies. Na aftrek van Mijn VerbouwPremie kan dat dalen naar 2 tot 3 jaar. Daarna is de isolatie pure winst: lagere factuur, comfortabeler huis, en een hogere verkoopwaarde bij eventuele verkoop. Isoprotech verzorgt de gratis inspectie en helpt u bij de premie-aanvraag. Het adres: P. van den Eedenstraat 84, 2660 Antwerpen — bereikbaar voor Wilrijk, Berchem, Deurne en de hele regio." },
      { type: "heading", content: "Welke dakisolatie-oplossing past bij uw woning?" },
      { type: "text", content: "Voor hellende daken met bewoonbare zolder wordt isolatie langs de binnenzijde het meest toegepast: PIR-platen of minerale wol tussen de spanten, afgewerkt met een dampscherm en pleisterplaten. Voor niet-bewoonbare zolders volstaat vloerisolatie op de zoldervloer — goedkoper en snel geplaatst. Bij platte daken wordt gewerkt met een 'warm dak'-opbouw: isolatieplaten bovenop de dakstructuur, gevolgd door een waterdichte bedekking. Isoprotech adviseert u na een gratis inspectie over de beste oplossing voor uw specifieke situatie." },
    ],
    relatedSlugs: ["dakisolatie-prijs-m2-2026", "epc-labelpremie-deadline-30-juni-2026", "dakisolatie-plat-hellend"],
    relatedServiceSlugs: ["dakisolatie", "dakrenovatie"],
    seo: {
      title: "Gasfactuur stijgt: dakisolatie besparing Antwerpen 2026",
      description: "Dakisolatie bespaart 20–30% op uw verwarmingsrekening. Terugverdientijd, prijzen, premies en tips voor Antwerpen 2026. ISOPROTECH.",
    },
  },
  {
    id: "epc-label-e-f-renovatieplicht-antwerpen-2026",
    slug: "epc-label-e-f-renovatieplicht-antwerpen-2026",
    title: "Woning gekocht met EPC-label E of F? Dit moet u doen om boetes te vermijden",
    date: "2026-05-26",
    dateDisplay: "26 mei 2026",
    category: "Renovatieplicht",
    readTime: "6 min",
    excerpt: "Kopers van een woning met EPC-label E of F zijn wettelijk verplicht om te renoveren. Wat zijn de deadlines, welke werken zijn verplicht en hoe pakt u dit aan?",
    photo: PHOTOS.gevelBefore1,
    body: [
      { type: "text", content: "Wie een woning koopt met EPC-label E of F, heeft in Vlaanderen 5 jaar de tijd om het label op te krikken naar minimum D. Dit is geen aanbeveling maar een wettelijke verplichting. Wie de deadline mist, kan verplicht worden het pand te verkopen of riskeert een boete. De goede nieuws: met gerichte isolatiewerken — dakisolatie, gevelisolatie of spouwmuurisolatie — haalt u label D in de meeste gevallen zonder ingrijpende verbouwing." },
      { type: "heading", content: "Wat zegt de renovatieplicht exact?" },
      { type: "text", content: "De Vlaamse renovatieplicht trad in werking op 1 januari 2023 en geldt voor alle woningen aangekocht na die datum met een EPC-label E of F. De koper heeft 5 jaar tijd om het label te verbeteren naar label D of beter. De referentiedatum is de datum van de authentieke akte bij de notaris. De verplichting geldt voor de eigenaar, niet voor huurders. Bij overtreding kan het VEA handhavend optreden — de sancties zijn nog in ontwikkeling maar kunnen bestaan uit boetes of gedwongen verkoop." },
      { type: "heading", content: "Welke werken brengen u van label E of F naar D?" },
      { type: "text", content: "Het meest effectieve pakket voor een snelle labelverbetering combineert dakisolatie en spouwmuurisolatie of gevelisolatie. Dakisolatie alleen levert gemiddeld 1 tot 1,5 labelstappen op. In combinatie met gevelisolatie of spouwmuurisolatie haalt u in de meeste gevallen 2 stappen — van F naar D of van E naar C. Welke combinatie optimaal is voor uw woning, hangt af van de bouwperiode, de constructie en het huidige EPC. Een erkend energiedeskundige stelt het voor- en na-EPC op." },
      { type: "heading", content: "Renovatieplicht en premies: kunt u tegelijk besparen?" },
      { type: "text", content: "Ja. Via Mijn VerbouwPremie kunt u voor de meeste isolatiewerken een premie aanvragen, ongeacht de renovatieplicht. Woningeigenaren in de laagste inkomensgroepen ontvangen een hogere premie. Bovendien geldt het verlaagde btw-tarief van 6% voor woningen ouder dan 10 jaar. De EPC-labelpremie (bij een aantoonbare labelsprong) was aanvullend beschikbaar tot 30 juni 2026. Combineer werken en vraag premies tegelijk aan voor maximale terugverdientijd." },
      { type: "heading", content: "Hoelang duurt de aanpak van label E naar label D in Antwerpen?" },
      { type: "text", content: "Dakisolatie van een gemiddelde rijwoning neemt 1 tot 3 werkdagen in beslag. Buitengevelisolatie of spouwmuurisolatie duurt afhankelijk van de oppervlakte 3 tot 10 werkdagen. U hebt 5 jaar de tijd, maar begin op tijd: het EPC-attest na renovatie moet worden aangemaakt door een erkend energiedeskundige, en dat kan enkele weken in beslag nemen. Isoprotech werkt in Antwerpen, Mortsel, Wilrijk, Berchem, Deurne, Edegem en omgeving. Vraag uw gratis inspectie aan — onze vakman komt binnen 48 uur langs." },
      { type: "heading", content: "Wat als u de renovatieplicht niet nakomt?" },
      { type: "text", content: "Het VEA monitort via het kadaster welke woningen onder de renovatieplicht vallen. Bij het verstrijken van de 5-jarige termijn zonder verbetering van het EPC-label kan het agentschap een waarschuwing sturen, gevolgd door handhaving. De sancties worden in 2026 verder uitgewerkt in uitvoeringsbesluiten, maar eigenaren riskeren een administratieve boete en mogelijk verplichte verkoop bij aanhoudende niet-naleving. Het risico is reëel — en de remedie is eenvoudiger dan de meeste eigenaars denken." },
    ],
    relatedSlugs: ["epc-labelpremie-deadline-30-juni-2026", "gevelisolatie-voordelen-2026", "dakisolatie-prijs-m2-2026"],
    relatedServiceSlugs: ["dakisolatie", "gevelisolatie", "spouwmuurisolatie"],
    seo: {
      title: "EPC-label E of F renovatieplicht Antwerpen 2026 — ISOPROTECH",
      description: "Woning gekocht met EPC E of F? U heeft 5 jaar om naar label D te renoveren. Deadlines, verplichte werken, premies en kosten in Antwerpen.",
    },
  },
];
