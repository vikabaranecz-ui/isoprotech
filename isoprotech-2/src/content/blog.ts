...
export const blogPosts: BlogPost[] = [
  {
    ...
    seo: {
      title: "7 Voordelen van Gevelisolatie in 2026",
  ...
  },
  {
    ...
    seo: {
      title: "Dakisolatie: Plat vs. Hellend Dak",
  ...
  },
  {
    ...
    seo: {
      title: "Crepi of Spuitkurk? Welke Afwerking Past?",
  ...
  },
  {
    ...
    relatedSlugs: ["gevelisolatie-voordelen-2026", "dakisolatie-plat-hellend", "epc-attest-aanvragen"],
    relatedServiceSlugs: ["gevelisolatie", "dakisolatie"],
    seo: {
      title: "EPC-label Verbeteren met Isolatie",
  ...
  {
    id: "epc-attest-aanvragen",
    slug: "epc-attest-aanvragen",
    title: "EPC-attest aanvragen in Vlaanderen: hoe werkt het?",
    date: "2026-03-02",
    dateDisplay: "2 maart 2026",
    category: "Energie",
    readTime: "6 min",
    excerpt: "Hoe en waar vraagt u een EPC-attest aan in Vlaanderen, wat kost het en wanneer is het verplicht?",
    photo: PHOTOS.gevelCrepiMeise2,
    body: [
      { type: "text", content: "Een EPC-attest (Energieprestatiecertificaat) is in Vlaanderen verplicht bij de verkoop of verhuur van een woning. Veel eigenaars weten niet precies hoe en waar ze dit attest moeten aanvragen. Dit artikel legt de procedure stap voor stap uit." },
      { type: "heading", content: "Wat is een EPC-attest?" },
      { type: "text", content: "Het EPC-attest toont hoe energiezuinig uw woning is en geeft een energielabel van A+ tot F. Het is wettelijk verplicht bij elke verkoop en verhuur in Vlaanderen, en moet al beschikbaar zijn op het moment dat u de woning te koop of te huur aanbiedt." },
      { type: "heading", content: "Hoe vraagt u een EPC-attest aan?" },
      { type: "text", content: "U kunt zelf geen EPC-attest opmaken — dit moet gebeuren door een erkende energiedeskundige type A. Via de website van het Vlaams Energie- en Klimaatagentschap (VEKA) vindt u een lijst van erkende energiedeskundigen in uw regio. Zij komen ter plaatse, nemen metingen op en stellen het attest op." },
      { type: "heading", content: "Wat kost een EPC-attest?" },
      { type: "text", content: "De kostprijs van een EPC-attest ligt doorgaans tussen 150 en 300 euro, afhankelijk van de grootte en complexiteit van de woning. Het attest is 10 jaar geldig, tenzij er ingrijpende verbouwingen gebeuren die het energieverbruik beïnvloeden." },
      { type: "heading", content: "Een slecht EPC-label? Eerst isoleren loont" },
      { type: "text", content: "Krijgt u een laag EPC-label, dan kan dat de verkoopwaarde van uw woning drukken en vanaf 2026 gelden bovendien strengere renovatieverplichtingen bij verkoop. Dak- en gevelisolatie zijn de twee maatregelen met de grootste impact op uw score. ISOPROTECH adviseert u graag welke werken het meeste opleveren vóór u een EPC-attest aanvraagt." },
    ],
    relatedSlugs: ["epc-label-verbeteren", "premies-renovatie-2026"],
    relatedServiceSlugs: ["gevelisolatie", "dakisolatie"],
    seo: {
      title: "EPC-attest Aanvragen Vlaanderen — Stap voor Stap",
      description: "EPC-attest aanvragen in Vlaanderen: wie mag het opmaken, wat kost het en wanneer is het verplicht? Plus tips om uw EPC-label te verbeteren.",
    },
  },
  {
    ...
    seo: {
      title: "Renovatiepremies Vlaanderen 2026 — Overzicht",
  ...
  },
  {
    ...
    seo: {
      title: "Asbest Herkennen in Uw Woning",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["gevelisolatie", "crepi", "spuitkurk"],
    seo: {
      title: "Gevelisolatie Prijs per m² 2026",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["gevelisolatie", "crepi", "spuitkurk"],
    seo: {
      title: "Buitenmuur Isoleren via de Buitenzijde",
  ...
  },
  {
    ...
    seo: {
      title: "Plat Dak Renoveren 2026 — EPDM of Groendak?",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["gevelisolatie", "dakisolatie"],
    seo: {
      title: "Isolatie Zonder Bouwvergunning — Wat Mag Wel?",
  ...
  },
  {
    ...
    seo: {
      title: "Energiezuinig Renoveren Stappenplan",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["gevelisolatie", "crepi", "spuitkurk"],
    seo: {
      title: "Spouwmuur of Buitengevelisolatie?",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["dakisolatie", "dakrenovatie"],
    seo: {
      title: "Dakisolatie Prijs per m² 2026 — Richtprijzen",
  ...
  {
    id: "dakisolatie-premie-2026",
    slug: "dakisolatie-premie-2026",
    title: "Dakisolatie Premie 2026 — Mijn VerbouwPremie en Andere Subsidies",
    date: "2026-06-01",
    dateDisplay: "1 juni 2026",
    category: "Premies & Subsidies",
    readTime: "6 min",
    excerpt: "Welke premies kunt u in 2026 aanvragen voor dakisolatie in Vlaanderen? Mijn VerbouwPremie, BTW 6%, energieleningen en hoe ISOPROTECH u begeleidt bij de aanvraag.",
    photo: PHOTOS.platDakAfter,
    body: [
      { type: "text", content: "Dakisolatie is een van de meest rendabele energetische ingrepen voor woningen in Vlaanderen. In 2026 kunt u van meerdere premies en fiscale voordelen genieten. Dit artikel geeft u een overzicht van de beschikbare steunsystemen en de voorwaarden waaraan u moet voldoen." },
      { type: "heading", content: "Mijn VerbouwPremie voor dakisolatie" },
      { type: "text", content: "De Vlaamse overheid biedt via Mijn VerbouwPremie een tegemoetkoming voor dakisolatie. U kunt de premie aanvragen als uw woning gebouwd is vóór 2006 en u werkt met een erkend aannemer. Het premiebedrag varieert naargelang uw inkomenscategorie en de aard van de werken. Controleer steeds de actuele bedragen op vlaanderen.be/mijn-verbouwpremie (geraadpleegd juni 2026), want de bedragen worden jaarlijks herzien." },
      { type: "heading", content: "Voorwaarden voor de premie" },
      { type: "text", content: "Om in aanmerking te komen voor de Mijn VerbouwPremie voor dakisolatie moet u voldoen aan een aantal voorwaarden: (1) de woning moet gebouwd zijn vóór 2006; (2) u moet een erkend aannemer inschakelen — ISOPROTECH is erkend aannemer; (3) de werken moeten een minimale factuurwaarde bereiken (doorgaans €3.000 incl. BTW); (4) de isolatie moet een minimale Rd-waarde halen. Dien de premieaanvraag in vóórdat de werken starten." },
      { type: "heading", content: "BTW 6% — ook een voordeel" },
      { type: "text", content: "Voor woningen ouder dan 10 jaar die uitsluitend privé worden gebruikt, geldt het verlaagde BTW-tarief van 6% op dakisolatiewerken — zowel op het arbeidsloon als op de materialen. Op een project van €8.000 scheelt dat ruim €1.200 ten opzichte van het standaardtarief van 21%. Dit voordeel is automatisch van toepassing en hoeft niet apart aangevraagd te worden." },
      { type: "heading", content: "Mijn VerbouwLening — 0% voor bepaalde doelgroepen" },
      { type: "text", content: "Naast de premie bestaat er ook de Mijn VerbouwLening, een renteloze lening voor dakisolatie bedoeld voor eigenaar-bewoners met een bescheiden inkomen. De lening kan worden gecombineerd met de Mijn VerbouwPremie. Informeer bij uw gemeente of OCMW voor de exacte voorwaarden in uw gemeente (bron: vlaanderen.be, geraadpleegd juni 2026)." },
      { type: "heading", content: "Hoe ISOPROTECH u helpt" },
      { type: "text", content: "ISOPROTECH begeleidt u doorheen het volledige premieproces: wij berekenen de isolatiewaarden voor uw EPB-dossier, stellen de vereiste technische fiches op en adviseren u over de aanvraagprocedure. Vraag een gratis inspectie aan en wij lichten toe welke premies op uw project van toepassing zijn." },
    ],
    relatedSlugs: ["gevelisolatie-premie-2026", "dakisolatie-prijs-per-m2", "dakisolatie-plat-hellend"],
    relatedServiceSlugs: ["dakisolatie", "dakrenovatie"],
    seo: {
      title: "Dakisolatie Premie 2026 — Mijn VerbouwPremie & BTW 6%",
      description: "Welke premies voor dakisolatie in Vlaanderen 2026? Mijn VerbouwPremie, BTW 6% en energieleningen uitgelegd. ISOPROTECH begeleidt uw aanvraag.",
    },
  },
  {
    id: "gevelisolatie-premie-2026",
    slug: "gevelisolatie-premie-2026",
    title: "Gevelisolatie Premie 2026 — Overzicht Subsidies voor Buitengevelisolatie",
    date: "2026-06-15",
    dateDisplay: "15 juni 2026",
    category: "Premies & Subsidies",
    readTime: "5 min",
    excerpt: "Premies voor gevelisolatie in 2026: Mijn VerbouwPremie, BTW 6% voordeel en energieleningen. Alle voorwaarden op een rij voor ETICS/crepi in Vlaanderen.",
    photo: PHOTOS.gevelCrepiMeise,
    body: [
      { type: "text", content: "Buitengevelisolatie (ETICS met crepi of steenstrips) is in 2026 een van de prioritaire maatregelen in het Vlaamse subsidiestelsel. Door de combinatie van directe premies, verlaagde BTW en beschikbare energieleningen is de terugverdientijd aanzienlijk korter geworden." },
      { type: "heading", content: "Mijn VerbouwPremie voor gevelisolatie" },
      { type: "text", content: "Via Mijn VerbouwPremie kunt u een tegemoetkoming aanvragen voor buitengevelisolatie. Voorwaarden: de woning is gebouwd vóór 2006, u werkt met een erkend aannemer, het project bereikt een minimale factuurwaarde en de isolatie haalt de vereiste minimale Rd-waarde (doorgaans Rd ≥ 1,5 m²K/W voor de gevel). De premie wordt berekend per m² geïsoleerde geveloppervlakte. Controleer de actuele bedragen op vlaanderen.be/mijn-verbouwpremie (geraadpleegd juni 2026)." },
      { type: "heading", content: "BTW 6% op gevelisolatiewerken" },
      { type: "text", content: "Op renovatiewerken aan woningen ouder dan 10 jaar geldt het verlaagde BTW-tarief van 6%. Dit geldt voor zowel de arbeid als de materialen bij gevelisolatie — crepi, steenstrips en het ETICS-systeem. Het verschil met 21% BTW bedraagt op een gemiddeld rijwoningproject van €7.000 al meer dan €1.000." },
      { type: "heading", content: "Combinatie met dakisolatiepremie" },
      { type: "text", content: "Doet u tegelijkertijd dak- en gevelisolatie? Dan kunt u voor beide werken afzonderlijk premie aanvragen via Mijn VerbouwPremie. Wie een totaalrenovatie uitvoert, komt bovendien in aanmerking voor een hogere globale premie in het kader van een ingrijpende energetische renovatie (IER). Uw EPB-verslaggever of ISOPROTECH helpt u dit optimaal in te plannen." },
      { type: "heading", content: "Omgevingsvergunning: wanneer nodig?" },
      { type: "text", content: "In veel Vlaamse gemeenten is ETICS op een gewone gevel vergunningsvrij, mits de kleur en textuur aanvaardbaar zijn voor de directe omgeving. In beschermde stadswijken of voor bepaalde geveltypes kan een omgevingsvergunning vereist zijn. ISOPROTECH adviseert u over de lokale regelgeving vóór de start van de werken." },
      { type: "heading", content: "Vraag uw premie tijdig aan" },
      { type: "text", content: "De premieaanvraag voor Mijn VerbouwPremie moet worden ingediend vóórdat de werken starten. Dient u de aanvraag pas na de werken in, dan verliest u het recht op de premie. ISOPROTECH helpt u de technische documentatie (Rd-berekening, materiaalfiches) en de aanvraag tijdig in orde te brengen." },
    ],
    relatedSlugs: ["dakisolatie-premie-2026", "gevelisolatie-voordelen-2026", "crepi-vs-spuitkurk"],
    relatedServiceSlugs: ["gevelisolatie", "crepi"],
    seo: {
      title: "Gevelisolatie Premie 2026 — Mijn VerbouwPremie & BTW 6%",
      description: "Premies voor gevelisolatie in Vlaanderen 2026: Mijn VerbouwPremie, BTW 6% voordeel en energieleningen voor ETICS/crepi. Alles wat u moet weten.",
    },
  },
];
