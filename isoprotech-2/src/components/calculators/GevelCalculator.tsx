      ...
      case 1:
        return (
          <div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {([
                { k: "spuitkurk" as const, t: "Spuitkurk", d: "Elastisch, ademend, naadloos", p: "€150/m²" },
                { k: "crepi" as const, t: "Crepi", d: "Strakke minerale pleister", p: "€142/m²" },
                { k: "steenstrips" as const, t: "Steenstrips", d: "Klinkerlook, dun en duurzaam", p: "€220/m²" },
                { k: "kaleien" as const, t: "Kaleien", d: "Limestone wash, zacht patina", p: "€155/m²" },
              ]).map((o) => (
                <RadioCard key={o.k} selected={input.finish === o.k} onClick={() => set("finish", o.k)} title={o.t} desc={o.d} badge={o.p} badgeColor="orange" />
              ))}
            </div>
          </div>
        );
        ...
        return (
          <div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 mb-5">
              <RadioCard selected={input.plinthType === "blauwesteen"} onClick={() => set("plinthType", "blauwesteen" as GevelPlinthType)} title="Gevelplint in blauwe steen" desc="Slagvast, premium uitstraling" badge="€115/lm" badgeColor="orange" />
              <RadioCard selected={input.plinthType === "spuitkurk"} onClick={() => set("plinthType", "spuitkurk" as GevelPlinthType)} title="Gevelplint in spuitkurk" desc="Naadloos, kleuraangepast" badge="€115/lm" badgeColor="orange" />
            </div>
