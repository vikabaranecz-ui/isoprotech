        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a href={SOCIAL.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/40 hover:text-orange-400 transition-colors">
              ...
              <a href={SOCIAL.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/40 hover:text-orange-400 transition-colors">
